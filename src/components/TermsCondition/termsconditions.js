...
const termsconditions = () => {
    return (
        ...
        <Row>
        <Col md={{span:6, offset:5}} sm={{span:10,offset:2}}>
        <h2 style={{marginTop:'150px', color:'#000'}}>Terms and Condition Page</h2>
        </Col></Row>
        <Container className="mt-3">
        <Row style={{marginTop:'30px',marginBottom:'15px'}}>
        <Col md={{span:4,offset:3}} sm={{span:4,offset:2}}>
        ...
        <Row>
        <Col md={{span:8,offset:3}} sm={{span:8,offset:2}}>
...
Website.com may, in its sole discretion, change or modify this Agreement at any time, with or without notice. Such changes or modifications shall be made effective for all Subscribers upon posting of the modified Agreement to this web address (URL): http://www.website.com/terms-and-conditions/. You are responsible to read this document from time to time to ensure that your use of the Service remains in compliance with this Agreement.</p>
        ...
        <p>Website.com offers Subscribers domain name registration, website hosting, and email hosting services for the duration of the service term purchased from Website.com.
...
Details regarding your account can be found in your account control panel (https://www.website.com/sign-in/)</p>
        </Col>
        </Row>
...
In the absence of a cancellation request from you, your hosting service will be renewed for a successive term, at the regular renewal rate, on the 16th of the expiry month.</p>
        </Col>
        </Row>
